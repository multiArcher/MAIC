...
EXPERIMENT_NAME=entity_catting_agent_test_protoss_5_vs_5  # Experiment name for logging.
CONFIG=entity_catting_agent_qmix  # Algorithm config name in src/config/alg
