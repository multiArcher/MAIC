...
EXPERIMENT_NAME=entity_feature_attend_agent_qmix_protpss_5_vs_5   # Experiment name for logging.
CONFIG=entity_feature_attend_agent_qmix  # Algorithm config name in src/config/alg
