...
class GRCMAC():
    ...
    def forward(self, ep_batch, t, test_mode=False):
        ...
        agent_outs, self.hidden_states = self.agent(agent_obs, messages, self.hidden_states)
    ...
    def _build_missing_feature_mask(self, rate, obs_dim):
        raise NotImplementedError

        # # The input shape of actor network.
        # # Including obs(obs_shape), agent_id(n_agents), communication_dim(defined by yaml).
        # # The communication dim should be code from the output of the Graph network.
        # # Communication from graph output
        # input_shape += self.args.message_feature_dim
        # Simulate message loss in communication.
        # Assume agents pass their obs directly at first stage.
        # TODO The communication signal should be coded first.
    ...
    def _build_messages(self, agent_obs, ep_batch, t: int) -> torch.Tensor:
        ...
        # TODO There should be a transform to get every agent's received message.
