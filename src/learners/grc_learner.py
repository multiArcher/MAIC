...
from controllers import CONTROLLER_TYPES


class GRCLearner:
    def __init__(self, mac: CONTROLLER_TYPES, scheme, logger, args):
        self.args = args
    ...
    def train(self, batch: EpisodeBatch, t_env: int, episode_num: int):
        ...
        if (
            ...
            # Update the target network with a hard update
        ...
        if t_env - self.log_stats_t >= self.args.learner_log_interval:
            # log the info of training process to tb/sacred/wandb.
